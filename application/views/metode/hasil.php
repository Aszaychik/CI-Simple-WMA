        ...
        <div class="col-7">
            <div class="card my-4">
                ...
                <div class="card-body px-3 pb-2">
                    ...
                    ?>
                    <h5 class="text-success">Hasil Prediksi : Kode <?= $h = $hasilnya->kode_kerusakan; ?> Kedip</h5>
        ...
        <div class="col-5">
            <div class="card my-4">
                ...
                <div class="card-body px-5 pb-2">
                    ...
                    <div class="row ">
                        <h6 class="col-6 text-center text-success">Total</h6>
                        <h6 class="col-6 text-start text-success">Rp <?= $t; ?></h6>
                    </div>
                </div>
            </div>
        </div>
